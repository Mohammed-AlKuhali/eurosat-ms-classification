...
\textbf{E1} is the ImageNet-pretrained RGB baseline; \textbf{E2}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.66\textwidth]{gradcam.png}
...
thin rivers, so its variance is high and it should be read as illustrative. Natural extensions are a spatial-holdout evaluation, larger or
