...
$12.1$~DN versus $946$--$2299$ for surface bands), so I exclude it and label the
...
match their pretraining distribution, so normalisation is a per-arm property. I
...
all-band$\}$ design (Fig.~\ref{fig:design}). As an optional extension I segment
